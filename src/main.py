...
def main():
    ...
    parser_bgc_clustering.add_argument('--clustering_type', type=str, help='tool to use for clustering BGCs into GCFs. Possible inputs are \"bigslice\", \"bigscape\" or \"both\" (default = both)', default = "both")
    ...
    parser_all_submodules.add_argument('--clustering_type', type=str, help='tool to use for clustering BGCs into GCFs. Possible inputs are \"bigslice\", \"bigscape\" or \"both\" (default = both)', default = "both")
